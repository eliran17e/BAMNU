  ...
  return (
    <section className="meme-wall section-pad" aria-labelledby="meme-title">
      ...
      <Reveal delay={120}><div className="meme-grid">
        ...
        <figure className="meme-square purple"><img src="/assets/day-38.webp" alt="BAMNU watching the charts" loading="lazy"/><figcaption>DAY {day}: STILL AWAKE.</figcaption></figure>
