...
export function Footer() {
  return (
    <footer>
      <div className="footer-top"><a className="wordmark light" href="#top">BAMNU<span>.</span></a><p>THE PANDA WHO REFUSED TO QUIT.</p><div><ExternalLink href={X_URL}>X ↗</ExternalLink><ExternalLink href={TIKTOK_URL}>TIKTOK ↗</ExternalLink><ExternalLink href={TELEGRAM_URL}>TELEGRAM ↗</ExternalLink><ExternalLink href={BUY_URL}>PUMP.FUN ↗</ExternalLink></div></div>
